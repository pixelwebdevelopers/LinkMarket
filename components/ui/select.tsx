    ...
    return (
      <div className="w-full">
        ...
        <select
          ...
          id={id}
          className={cn(
            "w-full rounded-xl bg-zinc-200/60 dark:bg-zinc-800/60 border border-zinc-300 dark:border-zinc-700 px-3.5 py-2.5 text-sm text-zinc-900 dark:text-zinc-100 cursor-pointer appearance-none",
            ...
            "disabled:bg-zinc-100 dark:disabled:bg-zinc-900 disabled:cursor-not-allowed",
        ...
        >
          {options.map((opt) => (
            <option key={opt.value} value={opt.value} className="bg-zinc-200 dark:bg-zinc-800">
              {opt.label}
            </option>
          ))}
        </select>
